                ...
                <AnimatedSection>
                    <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto 4rem' }}>
                        <div className="glass-card" style={{ padding: '2rem', marginBottom: '2rem' }}>
                            <h2 style={{ color: 'var(--color-primary)', fontSize: '2rem', marginBottom: '1rem', fontFamily: 'var(--ff-heading)' }}>🏆 National #1 Ranked Region</h2>
                            <p style={{ color: 'var(--color-black)', fontSize: '1.2rem', lineHeight: 1.6 }}>
                        ...
                        <p style={{ color: 'var(--color-gray-dark)', fontSize: 'var(--text-lg)', lineHeight: 1.6 }}>
                ...
                <AnimatedSection delay={100}>
                    <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto 4rem' }}>
                        <div className="glass-card" style={{ padding: '2rem', textAlign: 'center' }}>
                            <h3 style={{ color: 'var(--color-primary)', fontSize: '1.5rem', marginBottom: '1rem', fontFamily: 'var(--ff-heading)' }}>High-Performance Leadership</h3>
                            <p style={{ color: 'var(--color-gray-dark)', fontSize: '1.1rem', lineHeight: 1.6 }}>
